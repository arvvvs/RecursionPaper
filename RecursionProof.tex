...
{Definition.} A method of defining functions where the function is defined by its own defintion. 
\\
...
\\
In summary recursion is a method of defnining a sequence where each succesive object in the sequence is defined by the prrevious object in the sequence.  The initial objects are predefined.
